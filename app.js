...
// Utility: Sanitize HTML to prevent DOM XSS
...
function setupEventListeners() {
    ...
    if (cartItemsContainer) {
        cartItemsContainer.addEventListener('click', (e) => {
            ...
            if (minusBtn) {
                updateQuantity(minusBtn.getAttribute('data-id'), -1);
            } else if (plusBtn) {
                updateQuantity(plusBtn.getAttribute('data-id'), 1);
            } else if (removeBtn) {
                ...
                <div class="cart-item">
                    ...
                    <div class="cart-item-details">
                        ...
                        <div class="quantity-controls">
                            <button type="button" class="quantity-btn btn-minus" data-id="${escapeHTML(item.id)}">-</button>
                            <span>${Number(item.quantity)}</span>
                            <button type="button" class="quantity-btn btn-plus" data-id="${escapeHTML(item.id)}">+</button>
                        </div>
                    </div>
                    <button type="button" class="remove-item btn-remove" data-id="${escapeHTML(item.id)}">
